...
![studie_II_sheet](studie_II_sheet.jpg)
...
Stockhausen nel caso di Studie II effettua un'operazione simile a quella prospettica, perchè comprende che creare uno spazio di frequenze per ogni mistura, sezione o frase, diventa un po' come una prospettiva polverizzata in tante prospettive diverse. Dunque si organizza preventivamente quello spazio di frequenze soggiacente, cioè lo spazio scalare implicito al pensiero seriale, se lo organizza con il procedimento del temperamento con rapporto 5:1 come se fosse il rapporto 2:1 dell'ottava normale e considera la ![\sqrt[25]{5}](\sqrt[25]{5}.png) (ovvero 1.06649494220837), come il rapporto che ci permette di incrementare i valori della frequenza per moltiplicazioni successive. Il rapporto 5:1 delle sequenze viene diviso in tanti gradi discreti pari a un valore della frequenza moltiplicato per questo fattore ![\sqrt[25]{5}](\sqrt[25]{5}.png).
